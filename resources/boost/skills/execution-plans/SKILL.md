...
- Separate the user-facing review from the execution handoff. Present the complete decision in plain English first, using subject-appropriate headings and hiding internal metadata unless it affects the decision; create and deliver the precise structured handoff only after user approval.
