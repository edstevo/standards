...
- Keep action classes in `app/Actions/` or domain-local `Actions/` folders and name them as explicit verb-led tasks
- Use `Lorisleiva\Actions\Concerns\AsAction` and keep the core behaviour in `handle(...)`
